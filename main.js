...
function eliminar() {
    ...
    if (seleccion >0) {
        ...
        if (seleccion == 0) {
            document.getElementById('verelemento').value = "Sin elemento seleccionado";
        }else{
...
function agregarboton() {
    ...
    document.getElementById('resultado').innerHTML += '<button style="cursor:pointer;" onclick="seleccionar(this)" id="elemento'+conta+'">Elemento '+conta+'</button><br>';
...
function agregardiv() {
    ...
    seleccion = contador;
    contador = parseInt(contador) + 1;
    document.getElementById('resultado').innerHTML += '<div style="cursor:pointer;" onclick="seleccionar(this)" id="elemento'+conta+'">Elemento '+conta+'</div><br>';
    document.getElementById('verelemento').value = "Elemento "+conta;
...
function agregarimg() {
    ...
    seleccion = contador;
    contador = parseInt(contador) + 1;
    document.getElementById('resultado').innerHTML += '<img src="https://www.w3schools.com/html/html5.gif" style="cursor:pointer;" onclick="seleccionar(this)" id="elemento'+conta+'"><br>';
    document.getElementById('verelemento').value = "Elemento "+conta;
    reiniciarestado();
...
function agregarlink() {
    ...
    seleccion = contador;
    contador = parseInt(contador) + 1;
    document.getElementById('resultado').innerHTML += '<a style="cursor:pointer;" onclick="seleccionar(this)" href="#" id="elemento'+conta+'">Elemento '+conta+'</a><br>';
    document.getElementById('verelemento').value = "Elemento "+conta;
...
function agregartabla() {
    ...
    let tabla ='<table style="cursor:pointer;" id="elemento'+conta+'" onclick="seleccionar(this)" cellspacing="0" border="1">';
...
function agregarinput() {
    ...
    document.getElementById('resultado').innerHTML += '<input style="cursor:pointer;" onclick="seleccionar(this)" type="text" id="elemento'+conta+'" value="Elemento '+conta+'"><br>';
    document.getElementById('verelemento').value = "Elemento "+conta;
...
function agregarradio() {
    ...
    document.getElementById('resultado').innerHTML += '<input style="cursor:pointer;" onclick="seleccionar(this)" type="radio" id="elemento'+conta+'"><br>';
    document.getElementById('verelemento').value = "Elemento "+conta;
...
function animar() {
    ...
    if (document.getElementById('animacion').checked)
    {
        ...
        document.getElementById("elemento"+seleccion).classList.remove("animacion");
    }
}